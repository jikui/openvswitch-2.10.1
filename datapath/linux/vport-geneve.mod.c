...
__attribute__((section("__versions"))) = {
	...
	{ 0xc2d8da68, __VMLINUX_SYMBOL_STR(ovs_geneve_fill_metadata_dst) },
	{ 0xff1eea69, __VMLINUX_SYMBOL_STR(rpl_geneve_xmit) },
	...
	{ 0xca202065, __VMLINUX_SYMBOL_STR(rpl_geneve_dev_create_fb) },
...
MODULE_INFO(srcversion, "A4B9A43C241127A05075980");
