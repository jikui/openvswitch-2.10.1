...
DIST_COMMON = $(srcdir)/manpages.mk \
	...
	$(srcdir)/selinux/automake.mk $(srcdir)/build-aux/automake.mk \
	...
	$(openvswitchinclude_HEADERS) $(ovninclude_HEADERS) NEWS \
...
am__append_23 = lib/async-append-aio.c
#am__append_24 = lib/async-append-null.c
#am__append_25 = \
#	lib/route-table-stub.c \
#	lib/if-notifier-stub.c
...
am__lib_libopenvswitch_la_SOURCES_DIST = lib/aes128.c lib/aes128.h \
	...
	lib/dpif-netdev.h lib/dpif-netdev-perf.c \
	lib/dpif-netdev-perf.h lib/dpif-provider.h lib/dpif.c \
	lib/dpif.h lib/heap.c lib/heap.h lib/dynamic-string.c \
	...
	lib/netdev-provider.h lib/netdev-vport.c lib/netdev-vport.h \
...
am_lib_libopenvswitch_la_OBJECTS = lib/aes128.lo lib/backtrace.lo \
	...
	lib/dp-packet.lo lib/dpif-netdev.lo lib/dpif-netdev-perf.lo \
	...
	lib/multipath.lo lib/namemap.lo lib/netdev-dummy.lo \
	lib/netdev-vport.lo lib/netdev.lo lib/netlink.lo \
	lib/nx-match.lo lib/object-collection.lo lib/odp-execute.lo \
	lib/odp-util.lo lib/ofp-actions.lo lib/ofp-bundle.lo \
...
am_ovn_lib_libovn_la_OBJECTS = ovn/lib/acl-log.lo ovn/lib/actions.lo \
	...
	ovn/lib/extend-table.lo ovn/lib/lex.lo ovn/lib/ovn-util.lo \
	ovn/lib/logical-fields.lo
...
am__noinst_HEADERS_DIST = AUTHORS.rst CONTRIBUTING.rst LICENSE \
	MAINTAINERS.rst README.rst NOTICE .travis.yml \
	...
	Documentation/howto/firewalld.rst Documentation/howto/kvm.rst \
	...
	tests/ovsdb-rbac.at tests/ovsdb-cluster.at tests/ovs-vsctl.at \
	tests/ovs-xapi-sync.at tests/stp.at tests/rstp.at \
	tests/interface-reconfigure.at tests/vlog.at tests/vtep-ctl.at \
	tests/auto-attach.at tests/ovn.at tests/ovn-northd.at \
	...
	tests/system-interface.at tests/system-kmod-testsuite.at \
	...
	$(srcdir)/tests/system-dpdk-testsuite tests/atlocal.in \
	...
	include/sparse/rte_lcore.h include/sparse/rte_memcpy.h \
	...
	include/linux/pkt_cls.h include/linux/tc_act/tc_pedit.h \
...
ACLOCAL = ${SHELL} /root/workspace/openvswitch-2.10.1/build-aux/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /root/workspace/openvswitch-2.10.1/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/workspace/openvswitch-2.10.1/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /root/workspace/openvswitch-2.10.1/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /root/workspace/openvswitch-2.10.1/build-aux/missing automake-1.13
AWK = gawk
CAPNG_LDADD = 
CC = $(if $(C:0=),env REAL_CC="gcc -std=gnu99" CHECK="$(SPARSE) $(SPARSE_WERROR) -I $(top_srcdir)/include/sparse $(SPARSEFLAGS) $(SPARSE_EXTRA_INCLUDES) " cgcc $(CGCCFLAGS),gcc -std=gnu99)
...
KARCH = 
KBUILD = /lib/modules/3.10.0-957.1.3.el7.x86_64/build
...
LT_CURRENT = 0
LT_REVISION = 0
MAKEINFO = ${SHELL} /root/workspace/openvswitch-2.10.1/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
OVS_LDFLAGS = 
OVS_LTINFO = -release 2.10 -version-info 0:1
PACKAGE = openvswitch
PACKAGE_BUGREPORT = bugs@openvswitch.org
PACKAGE_NAME = openvswitch
PACKAGE_STRING = openvswitch 2.10.1
...
PYTHON3 = ${SHELL} /root/workspace/openvswitch-2.10.1/build-aux/missing python3
RANLIB = ranlib
...
VERSION = 2.10.1
VSTUDIO_CONFIG = 
WARNING_FLAGS =  -Wall -Wextra -Wno-sign-compare -Wpointer-arith -Wformat -Wformat-security -Wswitch-enum -Wunused-parameter -Wbad-function-cast -Wcast-align -Wstrict-prototypes -Wold-style-definition -Wmissing-prototypes -Wmissing-field-initializers -fno-strict-aliasing -Wshadow -Wno-null-pointer-arithmetic
abs_builddir = /root/workspace/openvswitch-2.10.1
abs_srcdir = /root/workspace/openvswitch-2.10.1
abs_top_builddir = /root/workspace/openvswitch-2.10.1
abs_top_srcdir = /root/workspace/openvswitch-2.10.1
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/workspace/openvswitch-2.10.1/build-aux/install-sh
...
CLEANFILES = all-distfiles all-gitfiles missing-distfiles distfiles \
	...
	vtep/vtep-ctl.8 vtep/ovs-vtep $(am__append_54) vtep/vtep.5 \
...
EXTRA_DIST = AUTHORS.rst CONTRIBUTING.rst LICENSE MAINTAINERS.rst \
	...
	.travis/osx-prepare.sh appveyor.yml boot.sh \
	...
	utilities/ovs-tcpundump.in utilities/ovs-test.in \
	utilities/ovs-vlan-test.in utilities/ovs-vsctl-bashcomp.bash \
	utilities/checkpatch.py $(bugtool_plugins) $(bugtool_scripts) \
	...
	$(SYSTEM_USERSPACE_TESTSUITE) $(SYSTEM_OFFLOADS_TESTSUITE) \
	$(SYSTEM_DPDK_TESTSUITE) tests/atlocal.in $(srcdir)/package.m4 \
	$(srcdir)/tests/testsuite $(srcdir)/tests/testsuite.patch \
	tests/valgrind-wrapper.in tests/glibc.supp tests/openssl.supp \
...
man_MANS = lib/ovs-fields.7 utilities/ovs-appctl.8 utilities/ovs-ctl.8 \
	...
	utilities/ovs-pki.8 utilities/ovs-tcpdump.8 \
	utilities/ovs-tcpundump.1 utilities/ovs-vlan-bug-workaround.8 \
	utilities/ovs-vsctl.8 $(am__append_37) vswitchd/ovs-vswitchd.8 \
...
scripts_SCRIPTS = utilities/ovs-check-dead-ifs utilities/ovs-ctl \
	...
	vtep/ovs-vtep ovn/utilities/ovn-ctl \
...
lib_libopenvswitch_la_SOURCES = lib/aes128.c lib/aes128.h \
	...
	lib/lldp/lldp.c lib/lldp/lldp-const.h lib/lldp/lldp-tlv.h \
	lib/lldp/lldpd.c lib/lldp/lldpd.h lib/lldp/lldpd-structs.c \
	lib/lldp/lldpd-structs.h $(am__append_15) $(am__append_16) \
	$(am__append_19) $(am__append_20) $(am__append_21) \
	$(am__append_22) $(am__append_23) $(am__append_24) \
	$(am__append_25) $(am__append_26) $(am__append_27) \
	$(am__append_28) lib/dns-resolve.h $(am__append_29) \
	$(am__append_30)
nodist_lib_libopenvswitch_la_SOURCES = \
	lib/dirs.c \
...
$(srcdir)/manpages.mk $(srcdir)/Documentation/automake.mk $(srcdir)/m4/automake.mk $(srcdir)/lib/automake.mk $(srcdir)/ofproto/automake.mk $(srcdir)/utilities/automake.mk $(srcdir)/utilities/bugtool/automake.mk $(srcdir)/tests/automake.mk $(srcdir)/include/automake.mk $(srcdir)/include/ovn/automake.mk $(srcdir)/include/openflow/automake.mk $(srcdir)/include/openvswitch/automake.mk $(srcdir)/include/sparse/automake.mk $(srcdir)/include/windows/automake.mk $(srcdir)/include/linux/automake.mk $(srcdir)/third-party/automake.mk $(srcdir)/debian/automake.mk $(srcdir)/vswitchd/automake.mk $(srcdir)/ovsdb/automake.mk $(srcdir)/rhel/automake.mk $(srcdir)/xenserver/automake.mk $(srcdir)/python/automake.mk $(srcdir)/tutorial/automake.mk $(srcdir)/vtep/automake.mk $(srcdir)/datapath-windows/automake.mk $(srcdir)/datapath-windows/include/automake.mk $(srcdir)/windows/automake.mk $(srcdir)/ovn/automake.mk $(srcdir)/ovn/controller/automake.mk $(srcdir)/ovn/controller-vtep/automake.mk $(srcdir)/ovn/lib/automake.mk $(srcdir)/ovn/northd/automake.mk $(srcdir)/ovn/utilities/automake.mk $(srcdir)/ovn/utilities/bugtool/automake.mk $(srcdir)/selinux/automake.mk $(srcdir)/build-aux/automake.mk:
